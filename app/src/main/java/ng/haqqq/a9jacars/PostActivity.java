...
public class PostActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private static final String SERVER_PATH = "http://192.168.43.73/";
    private Uri uri;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_GALLERY_CODE && resultCode == Activity.RESULT_OK) {
            ...
            if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                progressDialog.show();
                String filePath = getRealPathFromURIPath(uri, PostActivity.this);
                ...
                fileUpload.enqueue(new Callback<UploadObject>() {
                    ...
                    public void onResponse(Call<UploadObject> call, Response<UploadObject> response) {
                        ...
                        Toast.makeText(PostActivity.this, "Response " + response.raw().message(), Toast.LENGTH_LONG).show();
                        Toast.makeText(PostActivity.this, "Success " + response.body().getSuccess(), Toast.LENGTH_LONG).show();
                    }
